                           ...
                           arma::vec binf, arma::vec bsup, Function LogTest, int stream, int tt)
{
  ...
  PHI.row(0)= log((THETA.row(0).t()-binf)/(bsup-binf)/(1-(THETA.row(0).t()-binf)/(bsup-binf))).t();
  ...
  PHIwg.row(0) = log((THETAwg.row(0).t()-binf)/(bsup-binf)/(1-(THETAwg.row(0).t()-binf)/(bsup-binf))).t();
