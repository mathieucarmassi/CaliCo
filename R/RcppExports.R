...
#'
#' @export
resCpp <- function(fun, theta, s2) {
    .Call('_CaliCo_resCpp', PACKAGE = 'CaliCo', fun, theta, s2)
}

#' C++ implementation of time consuming loops for plot
#'
#' @export
resCppD <- function(fun, theta, thetaD, s2) {
    .Call('_CaliCo_resCppD', PACKAGE = 'CaliCo', fun, theta, thetaD, s2)
}
