...
The `plot` requires some inputs (\emph{i.e.} `plot(model,theta,sig2)`) where `theta` is the parameter value or vector and `sig2` the variance of the white Gaussian noise which represents the measurmement error.
