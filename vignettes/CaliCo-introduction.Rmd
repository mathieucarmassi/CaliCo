...
opt.estim1=list(Ngibbs=3000,Nmh=10000,thetaInit=c(11,0.01),k=c(1e-4,1e-4),sig=diag(2),Nchains=1,burnIn=2500)
...
```{r, echo=TRUE}
# Definition of the estimation options for the model 1 and model 2
opt.estim2=list(Ngibbs=3000,Nmh=10000,thetaInit=c(11,1,0.5,0.01),k=c(1e-5,1e-10,1e-10,1e-7),sig=diag(4),Nchains=1,burnIn=2500)
