...
```{r, echo=TRUE}
pr1 <- prior(type.prior=c("gaussian","gaussian","gamma"),opt.prior=list(c(2,0.1),c(1e-2,1e-5),c(1,0.05)))

opt.estim1=list(Ngibbs=1000,Nmh=5000,thetaInit=c(2,1e-2,0.05),k=c(1e-2,1e-4,1e-3),sig=diag(3),Nchains=1,burnIn=2000)
